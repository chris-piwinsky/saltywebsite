...
import blazeimage from '../images/blaze.png';
import riptideimage from '../images/riptide.png';
import killjoyimage from '../images/killjoy.png';
                ...
                <div className={styles.characterSummary}>
                    <div className={styles.characterContent}>
                        ...
                        <div className={styles.characterDescription}>
                            ...
                            <p>
                                KillJoy, the relentless buzzkill of our crew, is the raincloud on our parade, the spoiler of joyous moments, and the extinguisher of fireworks. You name it, KillJoy can bring it down. It is as if he was born with a No Fun Allowed sign on his forehead and a subscription to the Misery Monthly magazine.
                                Picture this: The crew is celebrating finding a hidden treasure chest, and just when everyone is about to do the happy dance, KillJoy chimes in with a gloomy factoid about treasure taxes, the environmental impact of chest excavation, or the existential crisis of gold doubloons. He may be a party pooper, but he is our party pooper. So, in the grand comedy of life on the high seas, KillJoy is the grumbling punchline we all secretly adore, because, lets face it, without him, the journey just would not be as hilariously bittersweet.
                            </p>
                        </div>
                    </div>
                </div>
